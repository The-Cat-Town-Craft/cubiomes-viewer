...
static const struct FilterList
{
    ...
    FilterList() : list{}
    {
        ...
        list[F_DESERT] = FilterInfo{
            ...
            QObject::tr("In version 1.18, desert pyramids depend on surface height and may fail to "
        ...
        list[F_MANSION] = FilterInfo{
            ...
            QObject::tr("In version 1.18, mansions depend on surface height and may fail to "
            "generate near caves/aquifers, rivers and oceans.")
        };
